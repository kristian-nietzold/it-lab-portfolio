...
This section demonstrates the configuration of Google Meet to support secure and controlled communication across the organisation.
...
!\[Meet safety settings](screenshots/10-01-meet-safety-settings.png)
